...
COPY --from=build \
     /opt/vep/.vep/bcftools/bcftools \
     /usr/local/bin/

COPY --from=build \
     /opt/vep/.vep/bcftools/misc/color-chrs.pl \
     /opt/vep/.vep/bcftools/misc/gff2gff.py \
     /opt/vep/.vep/bcftools/misc/guess-ploidy.py \
     /opt/vep/.vep/bcftools/misc/plot-vcfstats \
     /opt/vep/.vep/bcftools/misc/plot-roh.py \
     /opt/vep/.vep/bcftools/misc/run-roh.pl \
     /opt/vep/.vep/bcftools/misc/vcfutils.pl \
     /usr/local/bin/

COPY --from=build \
     /opt/vep/.vep/bcftools/doc/bcftools.1 \
     /usr/local/share/man/man1/

COPY --from=build \
     /opt/vep/.vep/bcftools/plugins/*.so \
